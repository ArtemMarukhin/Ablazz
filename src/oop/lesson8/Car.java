...
public class Car {
    ...
    public final static String BMW_INFO =
            "BMW - немецкая компания основанная в 1928 году";
    public final static String AUDI_INFO =
            "AUDi - немецкая компания основанная в 1933 году";
    public final static String KIA_INFO =
            "KIA - корейская компания основанная в 1950 году";
    ...
    public static void printBrands(){
        System.out.println("Перечень доступных брэндов: BMW, Audi, KIA");
    }
}
